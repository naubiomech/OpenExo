...
/**
    * @brief Handles raw (non-regressed) FSR signal, received via ESPNOW. 
    * 
    */
class FSR_Wireless
{
	public:
		FSR_Wireless(uint8_t addr, uint8_t reg, uint8_t len);
...
/**
    * @brief Handles regressed FSR signal, received via ESPNOW.
    * This is used for PJMC controller and is dependent on the type of FSR being used.
    * Current regression equation is for: Interlink 
    * 
    */
