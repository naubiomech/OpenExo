...
namespace UART_command_handlers
{
    ...
    inline static void get_real_time_data(UARTHandler *handler, ExoData *exo_data, UART_msg_t msg, uint8_t *config)
    {
        ...
        case (uint8_t)config_defs::exo_name::bilateral_arm:
		{
            ...
            rx_msg.data[1] = exo_data->right_side.arm_1.controller.desired_torque *10;
            rx_msg.data[2] = exo_data->left_side.arm_1.controller.motor_angle; //was filtered_torque_reading
            rx_msg.data[3] = exo_data->left_side.arm_1.controller.desired_torque * 10;
            rx_msg.data[4] = exo_data->right_side.arm_2.controller.motor_angle; //was filtered_torque_reading
            rx_msg.data[5] = exo_data->right_side.arm_2.controller.desired_torque * 10;
            rx_msg.data[6] = exo_data->left_side.arm_2.controller.motor_angle; //was filtered_torque_reading
            rx_msg.data[7] = exo_data->left_side.arm_2.controller.desired_torque * 10;
