...
class SideData {
    ...
    public:
        ...
        float toe_fsr_regressed;                    /**< Calibrate Regressed FSR reading for the toe */
        float toe_fsr_regressed_upper_threshold;    /**< Upper threshold for the regressed toe */
        float toe_fsr_regressed_lower_threshold;    /**< Lower threshold for the regressed toe */
        ...
        bool do_calibration_toe_fsr_regressed;              /**< Flag for if the regressed toe calibration should be done */
        bool do_calibration_refinement_toe_fsr_regressed;   /**< Flag for if the regressed toe calibration refinement should be done */
