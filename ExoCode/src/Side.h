...
class Side
{
	...
	private:
        ...
        FSR_Wireless _heel_fsr;                        /**< Heel force sensitive resistor, typically is a raw value */
		FSR_Regressed_Wireless _toe_fsr;               /**< Toe force sensitive resistor, typically is a regressed value */
