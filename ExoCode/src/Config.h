...
#include "LogLevels.h"
    ...
    #define AFO_Board_V0 6

    //Update the define below to match the board version being used
    #define BOARD_VERSION AFO_Board_V0 //Update this define to match the board version being used
	...
	#define CRITICAL_BATT_VAL 12 //In volts. Battery voltage below this will trigger the low battery warning in the GUI.
