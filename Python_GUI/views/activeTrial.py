...
class ActiveTrial(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Add two dropdowns to the right of the upper graph
        # Top right dropdown 1
        self.topRightDropdown1 = ttk.Combobox(self, values=[], 
                                             state="readonly", width=15)
        self.topRightDropdown1.set("Select Parameter")
        self.topRightDropdown1.place(relx=1.0, x=-20, rely=0.25, anchor="e")
        self.topRightDropdown1.bind('<<ComboboxSelected>>', self.on_dropdown_change)
        
        # Top right dropdown 2
        self.topRightDropdown2 = ttk.Combobox(self, values=[], 
                                             state="readonly", width=15)
        self.topRightDropdown2.set("Select Parameter")
        self.topRightDropdown2.place(relx=1.0, x=-20, rely=0.35, anchor="e")
        self.topRightDropdown2.bind('<<ComboboxSelected>>', self.on_dropdown_change)
        ...
        # Add two dropdowns to the right of the lower graph
        # Bottom right dropdown 1
        self.bottomRightDropdown1 = ttk.Combobox(self, values=[], 
                                                state="readonly", width=15)
        self.bottomRightDropdown1.set("Select Parameter")
        self.bottomRightDropdown1.place(relx=1.0, x=-20, rely=0.65, anchor="e")
        self.bottomRightDropdown1.bind('<<ComboboxSelected>>', self.on_dropdown_change)
        
        # Bottom right dropdown 2
        self.bottomRightDropdown2 = ttk.Combobox(self, values=[], 
                                                state="readonly", width=15)
        self.bottomRightDropdown2.set("Select Parameter")
        self.bottomRightDropdown2.place(relx=1.0, x=-20, rely=0.75, anchor="e")
        self.bottomRightDropdown2.bind('<<ComboboxSelected>>', self.on_dropdown_change)
        ...
        try:
            ...
            if cleaned_param_names:
                ...
                if self.topRightDropdown2.get() == "Select Parameter" and len(cleaned_param_names) > 1:
                    self.topRightDropdown2.set(cleaned_param_names[1])
                if self.bottomRightDropdown1.get() == "Select Parameter" and len(cleaned_param_names) > 0:
                    self.bottomRightDropdown1.set(cleaned_param_names[0])
